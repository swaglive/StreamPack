...
class StreamerFactory(
        ...
        return when {
            configuration.video.enable ->
                when(configuration.protocol) {
                    LivestreamProtocolType.SRT -> CameraSrtLiveStreamer(
                        context,
                    ...
                    LivestreamProtocolType.RTMP -> CameraRtmpLiveStreamer(
                        context,
                        enableAudio = enableAudio,
                    )
                }
            ...
            configuration.audio.enable ->
                when(configuration.protocol) {
                    LivestreamProtocolType.SRT -> AudioOnlySrtLiveStreamer(
                        context,
                        tsServiceInfo = tsServiceInfo
                    )
                    LivestreamProtocolType.RTMP -> AudioOnlyRtmpLiveStreamer(context)
                }
            else -> {
    ...
    fun build(): IStreamer {
        ...
        val videoConfig = VideoConfig(
            ...
            startBitrate = configuration.video.bitrate,
